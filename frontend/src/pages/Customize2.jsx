...
function Customize2() {
  ...
  return (
    <div  className='w-full h-[100vh] bg-gradient-to-t from-[black] to-[#0a0a5f] flex justify-center items-center flex-col p-[20px] relative '>
       <MdKeyboardBackspace className='absolute top-[30px] left-[30px] text-white cursor-pointer w-[25px] h-[25px]' onClick={()=>navigate("/customize")}/> 
        ...
        <input type="text" placeholder='eg. shifra' className='w-full max-w-[500px] h-[30px] outline-none border-2 border-white bg-transparent text-white placeholder-gray-300 px-[20px] py-[10px] rounded-full text-[15px]' required onChange={(e)=>setAssistantName(e.target.value)} value={assistantName}/>
